...
public class PipelineGroupsControllerV2 extends ApiController implements SparkSpringController, CrudController<PipelineConfigs> {
    ...
    public String update(Request req, Response res) {
        ...
        HttpLocalizedOperationResult result = new HttpLocalizedOperationResult();
        PipelineConfigs updatedPipelineConfigs = pipelineConfigsService.updateGroupAuthorization(SessionUtils.currentUsername(), pipelineConfigsFromServer, pipelineConfigsFromReq, etagFor(pipelineConfigsFromServer), entityHashingService, securityService, result);
